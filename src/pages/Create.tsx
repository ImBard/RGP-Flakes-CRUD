  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex flex-col items-center justify-center m-auto">
        <form onSubmit={handleCharacter} className="max-w-1/2 grid grid-cols-2 gap-8 p-6 bg-gray-700 rounded border border-gray-600">
          <input type="text" placeholder="Name" onChange={event => setName(event.target.value)} className="p-2 bg-gray-900 transition-colors rounded hover:bg-gray-600 " />
          <select
            className="p-2 transition-colors bg-gray-900 rounded hover:bg-gray-600"
            name=""
            id=""
          ...
          <input type="text" placeholder="Age" onChange={event => setAge(event.target.value)} className="p-2 bg-gray-900  transition-colors rounded hover:bg-gray-600 " />
          <input type="text" placeholder="HP" onChange={event => setHp(event.target.value)} className="p-2 bg-gray-900 transition-colors rounded hover:bg-gray-600 " />
          <input type="text" placeholder="Attack" onChange={event => setAttack(event.target.value)} className="p-2 transition-colors bg-gray-900 rounded hover:bg-gray-600 " />
          <input type="text" placeholder="Defense" onChange={event => setDefense(event.target.value)} className=" transition-colors p-2 bg-gray-900 rounded hover:bg-gray-600 " />
          <div className="col-end-3 flex justify-around gap-4 flex-wrap">
            <div className="flex items-center text-xl text-gray-200 hover:text-blue-500 transition-colors">
              <label className="flex gap-1 items-center font-bold">
                <input type="radio" name="gender" value={"male"} onChange={event => setGender(event.target.value)} id="male" />
                Male
              </label>
            </div>

            <div className="flex items-center gap-2 text-xl text-gray-200 hover:text-pink-500 transition-colors">
              <label className="flex gap-1 items-center font-bold">
            ...
            <div className="flex items-center gap-1 text-xl text-gray-200 hover:text-green-600 transition-colors">
              <label className="flex gap-1 items-center font-bold">
          ...
          <button
            className="col-span-2 bg-green-500 uppercase py-3 rounded font-bold text-sm hover:bg-green-700 transition-colors disabled:opacity-50"
